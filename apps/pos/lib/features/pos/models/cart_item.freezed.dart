...
abstract class $CartItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({MenuItem menuItem, int quantity});
...
class _$CartItemImpl extends _CartItem {
  const _$CartItemImpl({required this.menuItem, this.quantity = 1}) : super._();
...
abstract class _CartItem extends CartItem {
  const factory _CartItem(
      {required final MenuItem menuItem, final int quantity}) = _$CartItemImpl;
